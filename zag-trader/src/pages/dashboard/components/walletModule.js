      ...
      >
        <table>
          <tbody>
            ...
            {wallet.map((currencyItem) => (
              <tr key={currencyItem.unit}>
                <td>
                  <div className="td-currency-label">
                    <img src={currencyItem.currencyIcon} alt="icon"></img>{" "}
                    &nbsp; &nbsp;<span>{currencyItem.currency}</span>
                  </div>
                </td>
                <td>
                  <div className="td-currency-unit">
                    {currencyItem.balance} {currencyItem.unit}
                  </div>
                  <div>≈ 0 USD</div>
                </td>
